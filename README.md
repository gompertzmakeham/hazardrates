...
This code base is under active development, and is currently being tested against a data store of 19 distinct data sets containing nearly 3 billion healthcare utilization events, each with couple hundred features, covering more than 6 million individual persons, and two decades of surveillance. Approximately 175 million time intervals, each with four dozen features, are generated by Measure Theory consistent Temporal Joins and dimensional reduction, implemented in ad hoc map-reduce steps.
