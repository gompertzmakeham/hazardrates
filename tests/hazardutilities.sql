...
SELECT 'hazardutilities.anniversarystart(TRUNC(SYSDATE), SYSDATE)' functioncall, hazardutilities.anniversarystart(TRUNC(SYSDATE), SYSDATE) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TRUNC(SYSDATE), SYSDATE + 1)' functioncall, hazardutilities.anniversarystart(TRUNC(SYSDATE), SYSDATE + 1) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TRUNC(SYSDATE) - 1000, SYSDATE)' functioncall, hazardutilities.anniversarystart(TRUNC(SYSDATE) - 1000, SYSDATE) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20000301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20000301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20010301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20010301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20020301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20020301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20030301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20030301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20040301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20040301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20000301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20000301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20010301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20010301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20020301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20020301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20030301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20030301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20040301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20040301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20030228'', ''YYYYMMDD''), TO_DATE(''20030301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20030228', 'YYYYMMDD'), TO_DATE('20030301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20030228'', ''YYYYMMDD''), TO_DATE(''20040301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20030228', 'YYYYMMDD'), TO_DATE('20040301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversarystart(TO_DATE(''20030228'', ''YYYYMMDD''), TO_DATE(''20050301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversarystart(TO_DATE('20030228', 'YYYYMMDD'), TO_DATE('20050301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TRUNC(SYSDATE), SYSDATE)' functioncall, hazardutilities.anniversaryend(TRUNC(SYSDATE), SYSDATE) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TRUNC(SYSDATE), SYSDATE + 1)' functioncall, hazardutilities.anniversaryend(TRUNC(SYSDATE), SYSDATE + 1) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TRUNC(SYSDATE) - 1000, SYSDATE)' functioncall, hazardutilities.anniversaryend(TRUNC(SYSDATE) - 1000, SYSDATE) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20000301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20000301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20010301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20010301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20020301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20020301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20030301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20030301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000228'', ''YYYYMMDD''), TO_DATE(''20040301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000228', 'YYYYMMDD'), TO_DATE('20040301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20000301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20000301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20010301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20010301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20020301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20020301', 'YYYYMMDD')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.anniversaryend(TO_DATE(''20000229'', ''YYYYMMDD''), TO_DATE(''20030301'', ''YYYYMMDD''))' functioncall, hazardutilities.anniversaryend(TO_DATE('20000229', 'YYYYMMDD'), TO_DATE('20030301', 'YYYYMMDD')) callresult FROM dual UNION ALL
...
SELECT 'hazardutilities.ageyears(TO_DATE(''19800614'', ''yyyymmdd''), TO_DATE(''19850615'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800614', 'yyyymmdd'), TO_DATE('19850615', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800615'', ''yyyymmdd''), TO_DATE(''19850615'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800615', 'yyyymmdd'), TO_DATE('19850615', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800616'', ''yyyymmdd''), TO_DATE(''19850615'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800616', 'yyyymmdd'), TO_DATE('19850615', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800630'', ''yyyymmdd''), TO_DATE(''19850615'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800630', 'yyyymmdd'), TO_DATE('19850615', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790227'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790227', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790228'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790228', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790301'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790301', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790227'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790227', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790228'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790228', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790301'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790301', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790227'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790227', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790228'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790228', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19790301'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19790301', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800228'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800228', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800229'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800229', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800301'', ''yyyymmdd''), TO_DATE(''19840228'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800301', 'yyyymmdd'), TO_DATE('19840228', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800228'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800228', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800229'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800229', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800301'', ''yyyymmdd''), TO_DATE(''19840229'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800301', 'yyyymmdd'), TO_DATE('19840229', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800228'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800228', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800229'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800229', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
SELECT 'hazardutilities.ageyears(TO_DATE(''19800301'', ''yyyymmdd''), TO_DATE(''19840301'', ''yyyymmdd''))' functioncall, hazardutilities.ageyears(TO_DATE('19800301', 'yyyymmdd'), TO_DATE('19840301', 'yyyymmdd')) callresult FROM dual UNION ALL
