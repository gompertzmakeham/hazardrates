 ...
 */
	...
	WITH
		...
		(
			...
			SELECT 'surveillance' sectionname, 'surveymothernewborn' tablename FROM dual UNION ALL
			...
			SELECT 'census' sectionname, 'censusmothernewborn' tablename FROM dual UNION ALL
