...
CASE [hazardrate]
    ...
    WHEN 'GERIATRICPROCEDURES' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [GERIATRICPROCEDURES], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'GERIATRICIANSDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [GERIATRICIANSDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    ...
    WHEN 'GERIATRICDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [GERIATRICDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'GERIATRICPERCENTUTILIZATION' THEN
        100
            * SUM(IIF([CORNERCASE] = 'U' AND [GERIATRICPROCEDURES] > 0, [DURATIONDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    ...
    WHEN 'PEDIATRICPROCEDURES' THEN
        ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICPROCEDURES], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PEDIATRICIANSDAYS' THEN
        ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICIANSDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    ...
    WHEN 'PEDIATRICDAYS' THEN
        ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PEDIATRICPERCENTUTILIZATION' THEN
        100
            * SUM(IIF([CORNERCASE] = 'U' AND [PEDIATRICPROCEDURES] > 0, [DURATIONDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PEDIATRICSURGICALPROCEDURES' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICSURGICALPROCEDURES], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PEDIATRICSURGEONSDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICSURGEONSDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    ...
    WHEN 'PEDIATRICSURGERYDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PEDIATRICSURGERYDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PEDIATRICSURGERYPERCENTUTILIZATION' THEN
        100
            * SUM(IIF([CORNERCASE] = 'U' AND [PEDIATRICSURGICALPROCEDURES] > 0, [DURATIONDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PSYCHIATRYPROCEDURES' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PSYCHIATRYPROCEDURES], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PSYCHIATRISTSDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PSYCHIATRISTSDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    ...
    WHEN 'PSYCHIATRYDAYS' THEN
        1000
            * ATTR(1 + DATEDIFF('day', [CENSUSSTART], [CENSUSEND]))
            * SUM(IIF([CORNERCASE] = 'U', [PSYCHIATRYDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
    WHEN 'PATHOLOGYPERCENTUTILIZATION' THEN
        100
            * SUM(IIF([CORNERCASE] = 'U' AND [PSYCHIATRYPROCEDURES] > 0, [DURATIONDAYS], 0))
            / SUM(IIF([CORNERCASE] = 'U', [DURATIONDAYS], 0))
