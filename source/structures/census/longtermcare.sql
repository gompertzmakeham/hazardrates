...
SELECT
	...
	SUM(CASE WHEN a1.admit_date BETWEEN a2.intervalstart AND a2.intervalend THEN 1 ELSE 0 END) durationadmisions,
	SUM(CASE WHEN a1.discharge_date BETWEEN a2.intervalstart AND a2.intervalend THEN 1 ELSE 0 END) durationdischarges,
