CREATE MATERIALIZED VIEW censuspharmacydispense NOLOGGING COMPRESS NOCACHE PARALLEL 8 BUILD DEFERRED REFRESH COMPLETE ON DEMAND AS
WITH
...
COMMENT ON COLUMN censuspharmacydispense.standarddailydoses IS 'Naive sum of days supply dispensed from a community pharmacy of standard prescription therapeutics not subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.controlleddailydoses IS 'Naive sum of days supply dispensed from a community pharmacy of triple pad prescription therapeutics subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.alldailydoses IS 'Naive sum of days supply dispensed from a community pharmacy of all prescription therapeutics.';
COMMENT ON COLUMN censuspharmacydispense.standardtherapeutics IS 'Number of distinct standard prescription therapeutics dispensed from a community pharmacy not subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.controlledtherapeutics IS 'Number of distinct triple pad prescription therapeutics dispensed from a community pharmacy subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.alltherapeutics IS 'Number of distinct prescription therapeutics dispensed from a community pharmacy.';
COMMENT ON COLUMN censuspharmacydispense.standardsitedays IS 'Number of unique combinations of community pharmacies and days in the census interval when the person was dispensed a standard prescription of a therapeutic not subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.controlledsitedays IS 'Number of unique combinations of community pharmacies and days in the census interval when the person was dispensed a triple pad prescription of a therapeutic subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.allsitedays IS 'Number of unique combinations of community pharmacies and days in the census interval when the person was dispensed any prescription therapeutic.';
COMMENT ON COLUMN censuspharmacydispense.standarddays IS 'Number of unique days in the census interval when the person was dispensed from a community pharmacy a standard prescription of a therapeutic not subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.controlleddays IS 'Number of unique days in the census interval when the person was dispensed from a community pharmacy a triple pad prescription of a therapeutic subject to controlled substances regulations.';
COMMENT ON COLUMN censuspharmacydispense.alldays IS 'Number of unique days in the census interval when the person was dispensed from a community pharmacy any prescription therapeutic.';