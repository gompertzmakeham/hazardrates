CREATE MATERIALIZED VIEW surveyprimarycare NOLOGGING COMPRESS NOCACHE PARALLEL 8 BUILD DEFERRED REFRESH COMPLETE ON DEMAND AS
WITH
...
COMMENT ON COLUMN surveyprimarycare.leastsurveillanceend IS 'End date of the least observation bounds of the person.';
